...
\textbf{FIXME} Grazie ai dati relativi alle condizioni meteorologiche e 
all'ubicazione delle trappole il nostro obiettivo è quello di prevedere se le 
zanzare risultino positive al virus del Nilo occidentale.
...
Atmospheric Administration (NOAA). \textbf{FIXME descrivere brevemente cosa ci 
abbiamo fatto}
